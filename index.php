...
<head>
  ...
  <!-- Global site tag (gtag.js) - Google Analytics -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-41229794-14"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
		gtag('js', new Date());
		gtag('config', 'UA-41229794-14');
	</script>
 ...
 <!-- Google Tag Manager -->
	...
	})(window,document,'script','dataLayer','GTM-WDKPCBN');</script>
...
<body class="">
  ...
  <!-- <noscript>
	...
	<!-- Google Tag Manager (noscript) -->
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WDKPCBN"
			...
			<table class="table-a table-c table-c-a">
				<tbody>
					...
					<tr>
						...
						<td>
							<strong> カリキュラム概要 </strong> <br>
							Facebookでもベースとして使用され、世界で2.4億以上の実績があるPHPをメインに、データベースと連携したWebアプリの開発を行う。<br>
							後半は海外でも人気No.1のWebフレームワークLaravelを使用したより実践に近い開発手法を学び、同時にチーム開発の企画・設計を講師陣のサポートを得ながら進めていく。<br>
							<strong> 成果物 </strong> <br>
					...
					<tr>
						...
						<td>
							<strong> カリキュラム概要 </strong> <br>
							3～5人のチームでWEBフレームワークLaravelを使った実践チーム開発を行う。<br>
							市場調査・企画・設計・開発・テスト・リリースとシステム開発に必要な全工程を自分たちで0から行い、オリジナルWebサービスを世界にリリースする。<br>
							最終週に卒業プレゼンを在校生や講師オーディエンスの中実施。<br>
							大手IT企業のエンジニアが見学に来ることも。<br>
							<strong> 成果物 </strong> <br>
		...
		<div class="content">
			...
			<table class="table-a table-d table-d-a">
				<tbody>
					...
					<tr>
						<th rowspan="1">入学金</th>
						<td colspan="3">夜間コース参加後、セブ留学される場合、留学料金から10%オフが適用されます。</td>
					</tr>
					<tr>
					...
					<tr>
						<th rowspan="1">休校日</th>
						<td colspan="3">9/3、9/28、11/2、11/30、12/8、12/24、12/25、12/28～31</td>
					</tr>
				</tbody>
			</table>
				...
				<div class="stepbox">
					<div class="stepbox-inner">
						...
						<div class="stepbox-body">
							...
							<p>
								日本にNexSeedのグループ会社があるため、国内の銀行振り込みが可能です。<br>
								慣れない海外送金の必要はございません。<br>
								留学手続きでのご不明点についてのサポート体制も整っています。
							</p>
						</div>
					</div>
				</div>
				...
				<div class="stepbox">
					<div class="stepbox-inner">
						...
						<div class="stepbox-body">
							<h3>▼ 受講スタート</h3>
							<p>
								オンライン授業開始！ご自宅でPCからクラスに参加します。 <br>
								ご自身の目標を達成するため、仲間と一緒に成長していきましょう！
							</p>
						</div>
					</div>
				</div>
	...
	<div class="content">
		...
		<div class="accbox">
			...
			<p>
				...
				講義・質問対応などすべてオンラインで講師が手厚くサポートいたしますのでご安心ください。
			</p>
			</div>
	    	<!--//ラベル1-->
			<!--ラベル2-->
			...
			<!--ここに隠す中身-->
			<p>
				夜間じっくりコースでは、Webプログラミングの基本となるHTML/CSSの他、JavaScript、PHPをメインに学びます。また、海外でも人気No.1のWebフレームワークLaravelを使用し、より実践に近い開発手法を学び、チームで企画・設計・開発・テスト・リリースとシステム開発に必要な全工程を0から行い、オリジナルWebサービスを世界にリリースします。
			</p>
			</div>
			<!--//ラベル2-->
			<!--ラベル3-->
